...
// ../../node_modules/.pnpm/@prisma+engines-version@5.2.0-25.2804dc98259d2ea960602aca6b8e7fdc03c1758f/node_modules/@prisma/engines-version/package.json
var require_package = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.2.0-25.2804dc98259d2ea960602aca6b8e7fdc03c1758f/node_modules/@prisma/engines-version/package.json"(exports, module2) {
    module2.exports = {
      ...
      prisma: {
        enginesVersion: "2804dc98259d2ea960602aca6b8e7fdc03c1758f"
      },
      repository: {
        type: "git",
...
// ../../node_modules/.pnpm/@prisma+engines-version@5.2.0-25.2804dc98259d2ea960602aca6b8e7fdc03c1758f/node_modules/@prisma/engines-version/index.js
var require_engines_version = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.2.0-25.2804dc98259d2ea960602aca6b8e7fdc03c1758f/node_modules/@prisma/engines-version/index.js"(exports) {
    "use strict";
...
function getFieldArgName(field, modelName) {
  ...
  return getModelArgName(field.outputType.type.name);
}
...
function buildSingleFieldType(t, genericsInfo, source) {
  ...
  if (typeof t.type === "string") {
    ...
    type = namedType(`$Enums.${t.type.name}`);
  } else {
...
function buildOutputField(field) {
  ...
  if (typeof field.outputType.type === "string") {
    ...
    fieldType = namedType(field.outputType.type.name);
  }
...
function buildModelPayload(model, dmmf2) {
  const isComposite = hasOwnProperty(dmmf2.typeMap, model.name);
  const objects = objectType();
  const scalars = objectType();
  const composites = objectType();
  for (const field of model.fields) {
    if (field.kind === "object") {
      if (hasOwnProperty(dmmf2.typeMap, field.type)) {
      ...
      scalars.add(buildModelOutputProperty(field, dmmf2, true));
    }
  }
    ...
    for (const field of this.type.fields) {
      if (field.args.length) {
        if (field.outputType.location === "outputObjectTypes" && typeof field.outputType.type === "object") {
          argsTypes.push(
            new ArgsType(field.args, field.outputType.type, this.context).setGeneratedName(getModelFieldArgsName(field, this.model.name)).setComment(`${this.model.name}.${field.name}`)
          );
        }
      }
    }
...
${(0, import_indent_string4.default)(
      fields.filter((f) => {
        ...
        return f.outputType.location === "outputObjectTypes" && !hasOwnProperty(dmmf2.typeMap, fieldTypeName) && f.name !== "_count";
      }).map((f) => {
        const fieldTypeName = f.outputType.type.name;
        return `
...
var DMMFSchemaHelper = class {
  ...
  resolveOutputTypesInNamespace(namespace) {
  ...
  resolveNamespaceInputTypes(namespace) {
  ...
  resolveFieldArgumentTypesInNamespace(namespace) {
